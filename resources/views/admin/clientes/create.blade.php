                        ...
                        <form method="POST" action="{{ route('admin.clientes.store') }}">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="dados-da-empresa" role="tabpanel" aria-labelledby="dados-da-empresa-tab">
                                    ...
                                    @can('create_cliente')
                                    <div class="form-group">
                                        <label for="revenda_id">Revenda</label>
                                        <select class="form-control" id="revenda_id" name="revenda_id" required="required">
                                            <option></option>
                                            @foreach($data['revendas'] as $revenda)
                                                <option value="{{ $revenda->id }}">{{ $revenda->razao }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @endcan
